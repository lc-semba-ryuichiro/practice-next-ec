 ...
 * @returns The address form JSX element.
 */
function AddressForm(): React.JSX.Element {
            ...
            <form.AppField
              ...
              validators={{
                onBlur: ({ value }) => {
                  ...
                  // eslint-disable-next-line security/detect-unsafe-regex -- Simple zip code validation pattern
          ...
          <form.AppField
            ...
            validators={{
              onBlur: ({ value }) => {
                ...
                // eslint-disable-next-line security/detect-unsafe-regex -- Simple phone validation pattern
