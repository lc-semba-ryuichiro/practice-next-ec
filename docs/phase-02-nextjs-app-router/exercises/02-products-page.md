...
- [前提条件](#前提条件)
- [完成イメージ](#完成イメージ)
- [ステップ 1: モックデータの作成](#ステップ-1-モックデータの作成)
  - [1.1 型定義](#11-型定義)
  - [1.2 モックデータ](#12-モックデータ)
- [ステップ 2: 商品カードコンポーネント](#ステップ-2-商品カードコンポーネント)
  - [2.1 ファイル作成](#21-ファイル作成)
  - [2.2 画像のプレースホルダー](#22-画像のプレースホルダー)
- [ステップ 3: 商品一覧ページ](#ステップ-3-商品一覧ページ)
  - [3.1 ディレクトリ作成](#31-ディレクトリ作成)
  - [3.2 ページコンポーネント](#32-ページコンポーネント)
- [ステップ 4: ローディング UI](#ステップ-4-ローディング-ui)
  - [4.1 ローディングコンポーネント](#41-ローディングコンポーネント)
  - [4.2 ローディングの確認](#42-ローディングの確認)
- [ステップ 5: not-found ページ](#ステップ-5-not-found-ページ)
  - [5.1 404 ページ](#51-404-ページ)
