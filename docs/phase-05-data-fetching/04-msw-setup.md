...
- [MSW（Mock Service Worker）とは](#mswmock-service-workerとは)
  - [MSW のメリット](#msw-のメリット)
- [インストール](#インストール)
- [初期設定](#初期設定)
  - [Service Worker の生成](#service-worker-の生成)
  - [生成されるファイル](#生成されるファイル)
- [ハンドラーファイル構成](#ハンドラーファイル構成)
- [ハンドラーの作成](#ハンドラーの作成)
  - [ハンドラー集約ファイル](#ハンドラー集約ファイル)
  - [商品ハンドラー（例）](#商品ハンドラー例)
- [ブラウザ用設定](#ブラウザ用設定)
- [Node.js 用設定](#nodejs-用設定)
- [Next.js App Router での初期化](#nextjs-app-router-での初期化)
  - [方法 1: instrumentation.ts を使用（推奨）](#方法-1-instrumentationts-を使用推奨)
  - [方法 2: ブラウザでの初期化](#方法-2-ブラウザでの初期化)
- [モックデータの作成](#モックデータの作成)
  - [商品データ](#商品データ)
  - [カテゴリデータ](#カテゴリデータ)
- [環境変数による切り替え](#環境変数による切り替え)
  - [.env.development](#envdevelopment)
  - [.env.production](#envproduction)
  - [条件分岐](#条件分岐)
- [Storybook との統合](#storybook-との統合)
  - [インストール](#インストール-1)
  - [設定](#設定)
  - [ストーリーごとのハンドラー上書き](#ストーリーごとのハンドラー上書き)
- [トラブルシューティング](#トラブルシューティング)
  - [Service Worker が登録されない](#service-worker-が登録されない)
  - [ハンドラーが呼ばれない](#ハンドラーが呼ばれない)
  - [Next.js でエラーが発生する](#nextjs-でエラーが発生する)
- [まとめ](#まとめ)
- [次のステップ](#次のステップ)
