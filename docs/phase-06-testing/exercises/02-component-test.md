...
- [前提条件](#前提条件)
- [完成イメージ](#完成イメージ)
- [ステップ 1: テスト対象のコンポーネント](#ステップ-1-テスト対象のコンポーネント)
- [ステップ 2: テストファイルの作成](#ステップ-2-テストファイルの作成)
- [ステップ 3: 表示のテスト](#ステップ-3-表示のテスト)
- [ステップ 4: バッジのテスト](#ステップ-4-バッジのテスト)
- [ステップ 5: 在庫状態のテスト](#ステップ-5-在庫状態のテスト)
- [ステップ 6: インタラクションのテスト](#ステップ-6-インタラクションのテスト)
- [ステップ 7: 完成したテストコード](#ステップ-7-完成したテストコード)
- [確認チェックリスト](#確認チェックリスト)
- [トラブルシューティング](#トラブルシューティング)
  - [getByRole で要素が見つからない](#getbyrole-で要素が見つからない)
  - [screen.debug() で DOM を確認](#screendebug-で-dom-を確認)
  - [userEvent が動作しない](#userevent-が動作しない)
- [発展課題](#発展課題)
- [完了条件](#完了条件)
- [次の演習](#次の演習)
