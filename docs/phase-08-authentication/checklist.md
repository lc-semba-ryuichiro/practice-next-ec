...
- [動作確認](#動作確認)
  ...
  - [セッション](#セッション)
- [理解度確認クイズ](#理解度確認クイズ)
  - [Q1: 以下のコードの問題点は何ですか？](#q1-以下のコードの問題点は何ですか)
  - [Q2: JWT セッションを選ぶべき場合はどれですか？](#q2-jwt-セッションを選ぶべき場合はどれですか)
  - [Q3: 以下の Middleware の問題点は何ですか？](#q3-以下の-middleware-の問題点は何ですか)
- [次のステップ](#次のステップ)
