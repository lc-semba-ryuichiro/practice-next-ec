...
- [Next.js Middleware とは](#nextjs-middleware-とは)
  - [Middleware の特徴](#middleware-の特徴)
- [Middleware の基本構造](#middleware-の基本構造)
  - [ファイル配置](#ファイル配置)
  - [基本的な Middleware](#基本的な-middleware)
- [NextAuth.js と Middleware の連携](#nextauthjs-と-middleware-の連携)
  - [auth() 関数を使った認証チェック](#auth-関数を使った認証チェック)
  - [認証フローの図解](#認証フローの図解)
- [matcher 設定](#matcher-設定)
  - [基本的なパターン](#基本的なパターン)
  - [よく使うパターン](#よく使うパターン)
  - [パターンの優先度](#パターンの優先度)
- [複雑な認証ロジック](#複雑な認証ロジック)
  ...
  - [型定義の拡張](#型定義の拡張)
- [Edge Runtime の制約](#edge-runtime-の制約)
  - [使用できないもの](#使用できないもの)
  - [Edge 対応の例](#edge-対応の例)
  - [jose ライブラリの使用](#jose-ライブラリの使用)
- [リダイレクトパターン](#リダイレクトパターン)
  - [コールバック URL の保持](#コールバック-url-の保持)
  - [ログインページでのコールバック処理](#ログインページでのコールバック処理)
- [デバッグとトラブルシューティング](#デバッグとトラブルシューティング)
  - [ログの追加](#ログの追加)
  - [よくある問題と解決策](#よくある問題と解決策)
- [パフォーマンス考慮](#パフォーマンス考慮)
  - [Middleware を軽量に保つ](#middleware-を軽量に保つ)
  - [必要なルートのみに適用](#必要なルートのみに適用)
- [まとめ](#まとめ)
  - [学んだこと](#学んだこと)
- [次のステップ](#次のステップ)
