...
- [なぜ永続化が必要か](#なぜ永続化が必要か)
  - [ユーザー体験の向上](#ユーザー体験の向上)
- [atomWithStorage の基本](#atomwithstorage-の基本)
  - [インポート](#インポート)
  - [基本的な使い方](#基本的な使い方)
  - [引数](#引数)
- [EC サイトでの実装例](#ec-サイトでの実装例)
  - [ショッピングカートの永続化](#ショッピングカートの永続化)
  - [お気に入りの永続化](#お気に入りの永続化)
- [localStorage vs sessionStorage](#localstorage-vs-sessionstorage)
  - [違い](#違い)
  - [sessionStorage を使う場合](#sessionstorage-を使う場合)
  - [使い分けの例](#使い分けの例)
- [SSR での注意点](#ssr-での注意点)
  - [問題：Hydration Mismatch](#問題hydration-mismatch)
  - [解決策 1: クライアントコンポーネントを分離](#解決策-1-クライアントコンポーネントを分離)
  - [解決策 2: useHydrateAtoms を使用](#解決策-2-usehydrateatoms-を使用)
  - [解決策 3: クライアントサイドのみで表示](#解決策-3-クライアントサイドのみで表示)
- [カスタムストレージ](#カスタムストレージ)
  - [独自のストレージを作成](#独自のストレージを作成)
  - [暗号化ストレージ](#暗号化ストレージ)
- [デバッグ](#デバッグ)
  - [localStorage の確認](#localstorage-の確認)
  - [キー名の命名規則](#キー名の命名規則)
- [よくある問題と解決策](#よくある問題と解決策)
  - [1. 古いデータ構造との互換性](#1-古いデータ構造との互換性)
  - [2. ストレージ容量の上限](#2-ストレージ容量の上限)
- [まとめ](#まとめ)
  - [atomWithStorage のポイント](#atomwithstorage-のポイント)
  - [使いどころ](#使いどころ)
- [次のステップ](#次のステップ)
