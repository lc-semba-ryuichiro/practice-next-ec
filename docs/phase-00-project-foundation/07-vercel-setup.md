...
- [Vercel とは](#vercel-とは)
  - [特徴](#特徴)
- [アカウント作成](#アカウント作成)
  - [1. Vercel にサインアップ](#1-vercel-にサインアップ)
  - [2. GitHub との連携](#2-github-との連携)
- [プロジェクトのインポート](#プロジェクトのインポート)
  - [1. リポジトリを選択](#1-リポジトリを選択)
  - [2. プロジェクト設定](#2-プロジェクト設定)
  - [3. 環境変数の設定](#3-環境変数の設定)
- [vercel.json の設定](#verceljson-の設定)
  - [基本設定](#基本設定)
  - [詳細設定](#詳細設定)
- [環境変数の管理](#環境変数の管理)
  - [Dashboard での設定](#dashboard-での設定)
  - [環境ごとの設定](#環境ごとの設定)
  - [.env ファイルとの関係](#env-ファイルとの関係)
- [プレビューデプロイ](#プレビューデプロイ)
  - [仕組み](#仕組み)
  - [URL 形式](#url-形式)
  - [PR コメントの例](#pr-コメントの例)
  - [ブランチごとのプレビュー設定](#ブランチごとのプレビュー設定)
- [ドメインの設定](#ドメインの設定)
  - [カスタムドメインの追加](#カスタムドメインの追加)
  - [DNS 設定](#dns-設定)
  - [環境ごとのドメイン](#環境ごとのドメイン)
...
- [ビルド設定](#ビルド設定)
  - [推奨設定](#推奨設定)
  - [ビルドキャッシュ](#ビルドキャッシュ)
  - [Turborepo リモートキャッシュ](#turborepo-リモートキャッシュ)
- [Analytics と Speed Insights](#analytics-と-speed-insights)
