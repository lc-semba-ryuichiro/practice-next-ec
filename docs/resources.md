...
- [コミュニティ](#コミュニティ)
  ...
  - [英語コミュニティ](#英語コミュニティ)
  - [情報収集](#情報収集)
- [フェーズ別おすすめリソース](#フェーズ別おすすめリソース)
  - [Phase 0: プロジェクト基盤](#phase-0-プロジェクト基盤)
  - [Phase 1: React 基礎](#phase-1-react-基礎)
  - [Phase 2: Next.js App Router](#phase-2-nextjs-app-router)
  - [Phase 3: コンポーネント設計](#phase-3-コンポーネント設計)
  - [Phase 4: 状態管理](#phase-4-状態管理)
  - [Phase 5: データ取得](#phase-5-データ取得)
  - [Phase 6: テスト](#phase-6-テスト)
  - [Phase 7-9: フルスタック機能](#phase-7-9-フルスタック機能)
  - [Phase 10-11: パフォーマンス・SEO](#phase-10-11-パフォーマンスseo)
