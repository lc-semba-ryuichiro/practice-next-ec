...
- [ステップ 1: Zod スキーマの作成](#ステップ-1-zod-スキーマの作成)
  - [1.1 住所スキーマの作成](#11-住所スキーマの作成)
  - [1.2 エクスポートの追加](#12-エクスポートの追加)
- [ステップ 2: 郵便番号検索 API](#ステップ-2-郵便番号検索-api)
  - [2.1 郵便番号検索の型定義](#21-郵便番号検索の型定義)
  - [2.2 郵便番号を検索する関数](#22-郵便番号を検索する関数)
- [ステップ 3: Server Action の実装](#ステップ-3-server-action-の実装)
  - [3.1 住所保存アクションの作成](#31-住所保存アクションの作成)
- [ステップ 4: フォームコンポーネントの実装](#ステップ-4-フォームコンポーネントの実装)
  - [4.1 セレクトフィールドコンポーネント](#41-セレクトフィールドコンポーネント)
  - [4.2 住所フォームコンポーネント](#42-住所フォームコンポーネント)
- [ステップ 5: ページの作成](#ステップ-5-ページの作成)
  - [5.1 住所入力ページ](#51-住所入力ページ)
...
- [トラブルシューティング](#トラブルシューティング)
  - [郵便番号検索が動作しない](#郵便番号検索が動作しない)
  - [都道府県の選択が反映されない](#都道府県の選択が反映されない)
- [完了条件](#完了条件)

## 目標

ECサイトの購入フローで使用する配送先住所フォームを実装します。
