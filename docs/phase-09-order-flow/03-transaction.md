...
- [トランザクションとは](#トランザクションとは)
  - [ACID 特性](#acid-特性)
- [EC サイトでのトランザクション](#ec-サイトでのトランザクション)
  - [注文処理の流れ](#注文処理の流れ)
  - [トランザクションが必要な処理](#トランザクションが必要な処理)
- [実装パターン](#実装パターン)
  - [1. 擬似トランザクション（補償トランザクション）](#1-擬似トランザクション補償トランザクション)
  - [2. データベーストランザクション](#2-データベーストランザクション)
- [在庫管理](#在庫管理)
  - [在庫確認のタイミング](#在庫確認のタイミング)
  - [在庫確認の実装](#在庫確認の実装)
  - [在庫予約パターン](#在庫予約パターン)
- [楽観的ロック vs 悲観的ロック](#楽観的ロック-vs-悲観的ロック)
  - [楽観的ロック](#楽観的ロック)
  - [悲観的ロック](#悲観的ロック)
  - [比較](#比較)
...
- [MSW でのモック](#msw-でのモック)
- [よくある間違い](#よくある間違い)
  - [1. トランザクションなしで複数の更新](#1-トランザクションなしで複数の更新)
  - [2. 在庫チェックと減算の間に時間差](#2-在庫チェックと減算の間に時間差)
- [まとめ](#まとめ)
  - [トランザクションの要点](#トランザクションの要点)
  - [EC サイトでの実践](#ec-サイトでの実践)
- [次のステップ](#次のステップ)
