...
- [完成イメージ](#完成イメージ)
- [前提条件](#前提条件)
- [ステップ 1: バリデーションスキーマの作成](#ステップ-1-バリデーションスキーマの作成)
  - [1.1 配送先スキーマ](#11-配送先スキーマ)
- [ステップ 2: ページの作成](#ステップ-2-ページの作成)
  - [2.1 配送先入力ページ](#21-配送先入力ページ)
- [ステップ 3: フォームコンポーネント](#ステップ-3-フォームコンポーネント)
  - [3.1 配送先フォーム](#31-配送先フォーム)
  - [3.2 汎用フォームフィールド](#32-汎用フォームフィールド)
- [ステップ 4: Server Action](#ステップ-4-server-action)
- [ステップ 5: 郵便番号から住所を自動入力（オプション）](#ステップ-5-郵便番号から住所を自動入力オプション)
  - [5.1 郵便番号検索 API](#51-郵便番号検索-api)
  - [5.2 フォームでの使用](#52-フォームでの使用)
- [確認ポイント](#確認ポイント)
- [よくある問題](#よくある問題)
  - [1. バリデーションエラーが表示されない](#1-バリデーションエラーが表示されない)
  - [2. リダイレクトが動作しない](#2-リダイレクトが動作しない)
- [次の演習](#次の演習)
