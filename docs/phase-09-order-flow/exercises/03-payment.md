...
- [完成イメージ](#完成イメージ)
- [前提条件](#前提条件)
- [ステップ 1: 支払い方法スキーマ](#ステップ-1-支払い方法スキーマ)
- [ステップ 2: ページの作成](#ステップ-2-ページの作成)
- [ステップ 3: フォームコンポーネント](#ステップ-3-フォームコンポーネント)
  - [3.1 支払い方法フォーム](#31-支払い方法フォーム)
  - [3.2 クレジットカードフォーム](#32-クレジットカードフォーム)
- [ステップ 4: Server Action](#ステップ-4-server-action)
- [ステップ 5: カード番号のフォーマット（オプション）](#ステップ-5-カード番号のフォーマットオプション)
- [確認ポイント](#確認ポイント)
...
購入フローの3番目のステップとして、支払い方法を選択する画面を実装します。
...
- カード情報を直接扱う場合はPCI DSSへの準拠が必要
- Stripe, PAY.JPなどの決済代行サービスを使用する
