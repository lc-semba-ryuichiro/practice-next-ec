...
- [完成イメージ](#完成イメージ)
- [前提条件](#前提条件)
- [ステップ 1: 注文完了ページ](#ステップ-1-注文完了ページ)
- [ステップ 2: 状態のクリア](#ステップ-2-状態のクリア)
- [ステップ 3: 注文取得関数](#ステップ-3-注文取得関数)
- [ステップ 4: 注文履歴ページ](#ステップ-4-注文履歴ページ)
  - [4.1 注文一覧ページ](#41-注文一覧ページ)
  - [4.2 注文詳細ページ](#42-注文詳細ページ)
- [ステップ 5: 注文 API（MSW モック）](#ステップ-5-注文-apimsw-モック)
- [確認ポイント](#確認ポイント)
- [発展課題](#発展課題)
  - [1. 注文確認メールの送信](#1-注文確認メールの送信)
  - [2. 注文ステータスの追跡](#2-注文ステータスの追跡)
- [まとめ](#まとめ)
- [次のステップ](#次のステップ)
...
すべての演習が完了したら、[チェックリスト](../checklist.md) で学習内容を確認しましょう。
